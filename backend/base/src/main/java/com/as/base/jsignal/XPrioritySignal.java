...
/**
 * The XPrioritySignal class is an extension of XSignal that dispatches to its
 ...
 * @see XSignal
 */
public final class XPrioritySignal<E extends Comparable<E>> extends XSignal {
     ...
     */
    public XPrioritySignal(Class<?>... params) {
        this(11, params);
    }
     ...
     * @param params          the parameter types (as a Class instance) that this signal will dispatch as event data
     */
    public XPrioritySignal(int initialCapacity, Class<?>... params) {
        super(params);
    ...
    public Object add(Object listener, String callback, boolean addOnce, E priority) {
        ...
        ISlot newSlot = new XPrioritySlot<E>(listener, delegate, addOnce, priority);
    ...
    /**
     * @see XSignal#add(Object, String, boolean)
     */
    @Override

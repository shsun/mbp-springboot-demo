 ...
 * @author sh
 *
 * The XWeakSignal class is functionally the same as the XSignal class, however,
 * it maintains weak references to its listeners that are automatically cleaned up.
 * It is useful for memory sensitive systems where XSignal's can't be responsible
 ...
 * @see XSignal
 */
final class XWeakSignal extends XSignal {
    ...
    public Object add(Object listener, String callback, boolean addOnce) {
        ...
        ISlot previous = listenerMap.put(listener, new XWeakSlot(listener, delegate, addOnce));

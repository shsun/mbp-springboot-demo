 ...
 * @author sh
 *
 * The XSignal class acts as an event dispatcher for
 ...
 * <p>
 * This is a port of Robert Penner's XSignals for ActionScript 3.0
 */
public class XSignal implements IXSignalOwner {
    ...
    public Object add(Object listener, String callback, boolean addOnce) {
        ...
        ISlot previous = listenerMap.put(listener, new XSlot(listener, delegate, addOnce));
     ...
     * unique listenerMap are registered to this signal, ensure their <code>hashCode()</code> value is unique.
     * <p>
     * This is an overloaded version of <code>XSignal.add(Object, String, boolean)</code>.  By default, addOnce
     * is <b>false</b>.
     *
     * @param listener the listener object to add
     * @param callback the callback method, as a String, to invoke when this signal is dispatched
    ...
    /**
     * Dispatches this XSignal to all listenerMap using the given arguments.
     *
     * @param args the argument list to dispatch to listenerMap.  The argument
     *             list must have the same signature as the parameter list this XSignal
     *             was constructed with
    ...
    /**
     * Get the number of listenerMap currently registered to this XSignal.
     *
     * @return the number of listenerMap currently registered to this XSignal
     */
    @Override

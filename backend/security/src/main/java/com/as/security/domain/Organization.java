...
@Setter
@ToString
//public class Organization extends AbstractAuditable implements Nameable<Integer> {
public class Organization extends XSuperEntity<Organization> implements Nameable<Integer> {
    ...
    public static Organization of(Integer parentId, String name) {
    ...
    public static Organization of(Organization parent, String name, String description) {
        Organization org = new Organization();
        if (parent == null) {
            org.setLevel((byte) 1);
        } else {
